...
class TrainingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create training" do
    assert_difference('Training.count') do
      post trainings_url, params: { training: { e_no: @training.e_no, generate_no: @training.generate_no, result_no: @training.result_no, training: @training.training, training_type: @training.training_type } }
    end
  ...
  test "should update training" do
    patch training_url(@training), params: { training: { e_no: @training.e_no, generate_no: @training.generate_no, result_no: @training.result_no, training: @training.training, training_type: @training.training_type } }

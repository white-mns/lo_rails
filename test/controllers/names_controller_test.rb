...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { e_no: @name.e_no, generate_no: @name.generate_no, name: @name.name, player: @name.player, result_no: @name.result_no } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { e_no: @name.e_no, generate_no: @name.generate_no, name: @name.name, player: @name.player, result_no: @name.result_no } }

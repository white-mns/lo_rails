...
class TrainingsTest < ApplicationSystemTestCase
  ...
  test "creating a Training" do
    ...
    fill_in "E No", with: @training.e_no
    fill_in "Generate No", with: @training.generate_no
    fill_in "Result No", with: @training.result_no
    fill_in "Training", with: @training.training
    fill_in "Training Type", with: @training.training_type

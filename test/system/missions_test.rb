...
class MissionsTest < ApplicationSystemTestCase
  ...
  test "creating a Mission" do
    ...
    fill_in "Col", with: @mission.col
    fill_in "E No", with: @mission.e_no
    fill_in "Generate No", with: @mission.generate_no
    fill_in "Lv", with: @mission.lv
    fill_in "Mission", with: @mission.mission_id
    fill_in "Result No", with: @mission.result_no
    fill_in "Status", with: @mission.status
    fill_in "Type", with: @mission.type

class Damage < ApplicationRecord
	...
	belongs_to :parameter_fight,        :foreign_key => [:e_no, :result_no, :generate_no],         :primary_key => [:e_no, :result_no, :generate_no], :class_name => 'ParameterFight'
	belongs_to :target_parameter_fight, :foreign_key => [:target_e_no, :result_no, :generate_no],  :primary_key => [:e_no, :result_no, :generate_no], :class_name => 'ParameterFight'
